                    ...
                    >
                        <div className="ir__q-inner">
                            <div className="ir__q-block ir__q-block--intention">
                                <div className="ir__q-block-label">
                                    🎯 Interviewer's Intention
                                </div>
                                <p className="ir__q-block-text">
                                    {q.intention}
                                </p>
                            </div>
                ...
                <main className="ir__main">
                    ...
                    >
                        <div className="ir__score-hero">
                            ...
                            <div className="ir__score-info">
                                ...
                                <p>
                                    Your profile matches this job description
                                    well. Focus on the skill gaps and
                                    preparation plan below to maximize your
                                    chances.
                                </p>
                                <span
                                    className={`ir__score-tag ir__score-tag--${sv}`}
                                >
                                    {sv === "high"
                                        ? "🟢"
                                        : sv === "medium"
                    ...
                    >
                        <div className="ir__section-head">
                            ...
                            <h2 className="ir__section-title">
                                Technical Questions
                            </h2>
                            <span className="ir__section-count">
                            ...
                            {report.preparationPlan.map((day, i) => (
                                ...
                                >
                                    <div className="ir__day-marker">
                                        <div className="ir__day-dot">
                                            Day-{day.day}
                                        </div>
                                    </div>
                                    <div className="ir__day-content">
                                        <div className="ir__day-focus">
                                            {day.focus}
                                        </div>
                    ...
                    >
                        ...
                        <div className="ir__gaps">
                            {report.skillGaps.map((g, i) => (
                                ...
                                >
                                    <span
                                        className={`ir__gap-dot ir__gap-dot--${g.severity}`}
                                    />
                                    <span className="ir__gap-name">
                                        {g.skill}
                                    </span>
                                    <span
                                        className={`ir__gap-badge ir__gap-badge--${g.severity}`}
                                    >
                                        {g.severity}
                                    </span>
                                </motion.div>
                ...
                <aside className="ir__right">
                    ...
                    <div>
                        ...
                        {[
                            {
                                label: "Technical",
                                val: report.technicalQuestions.length,
                                max: 10,
                                color: "var(--accent)"
                            },
                            {
                                label: "Behavioral",
                                val: report.behavioralQuestions.length,
                                max: 10,
                                color: "var(--teal)"
                            },
                            {
                                label: "Prep Days",
                                val: report.preparationPlan.length,
                                max: 7,
                                color: "var(--gold)"
                            }
