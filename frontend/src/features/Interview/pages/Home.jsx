...
export default function HomePage() {
    const { loading, handleGenerateInterviewReport, aiError, setAiError } =
        useInterview();
    ...
    const handleValidation = async e => {
        ...
        if (!formData.jobDescription.trim()) {
            ...
            newErrors.jobDescription =
                "Job description is too short to generate a good report.";
        }
        ...
        >
            ...
            <main className="max-w-wrapper">
                <header className="hero">
                    ...
                    >
                        Upload your resume, describe your background, and get a
                        personalized interview prep strategy powered by AI — in
                        seconds.
                    </motion.p>
                </header>
                ...
                <div className="content-grid">
                    ...
                    >
                        <div className="form-header">
                            ...
                            <p>
                                Fill in the details below — the more context you
                                give, the better your report.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    animate={
                                        errors.jobDescription ? "shake" : "rest"
                                    }
                                    key={`job-desc-${submitCount}`}
                                >
                                    <textarea
                                        rows="4"
                                    ...
                                    <div className="char-count">
                                        {formData.jobDescription.length} / 3000
                                    </div>
                                </motion.div>
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    variants={shakeVariants}
                                    animate={
                                        errors.aboutYourself ? "shake" : "rest"
                                    }
                                    key={`about-you-${submitCount}`}
                                >
                                    <textarea
                                        rows="4"
                                    ...
                                    />
                                    <div className="char-count">
                                        {formData.aboutYourself.length} / 2000
                                    </div>
                                </motion.div>
                            ...
                            <motion.button
                                ...
                                style={{
                                    ...
                                    display: "flex", // Ensures the spinner and text align perfectly
                                    alignItems: "center",
                                    justifyContent: "center",
                                    gap: "10px" // Adds nice spacing between spinner and text
                                }}
                            >
                                {loading ? (
                                    <>
                                        {/* Framer Motion SVG Spinner */}
                                        <motion.svg
                                            animate={{ rotate: 360 }}
                                            transition={{
                                                repeat: Infinity,
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                <h3>Match Score</h3>
                                <p>
                                    See how well your profile aligns with the
                                    job requirements instantly.
                                </p>
                            </div>
                        </motion.div>
                        {/* Feature 2 */}
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p>
                                    Get tailored technical and behavioral
                                    questions unique to your background.
                                </p>
                            </div>
                        </motion.div>
                        {/* Feature 3 */}
                        ...
                        >
                            ...
                            <div>
                                <h3>Prep Roadmap</h3>
                                <p>
                                    A day-by-day study plan to close skill gaps
